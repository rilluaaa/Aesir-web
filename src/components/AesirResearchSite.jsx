...
const researchAreas = [
  {
    ...
    stages: [
      ...
      },
      {
        ...
        body: [
          ...
          "Environmental learning games extend the same principle into citizen science and public education. Together, these deployments create an applied foundation for evaluating participation, comprehension, accessibility, and adoption—evidence that can inform more inclusive healthcare, community services, and smart-city infrastructure.",
        ],
      },
    ],
    ...
    cases: [
      ...
      },
      {
        ...
        description:
          "Environmental web games translate university research on ocean protection, water filtration, and sustainability into accessible public learning tools that connect knowledge with everyday action.",
      },
    ],
  },
  {
    ...
    cases: [
      ...
      },
      {
        ...
        description:
          "Cantonese speech training and language-learning assistants provide an applied foundation for studying attention, feedback, and cognitive load across recognition and communication tasks.",
      },
      {
